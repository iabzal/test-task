        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card border-0 shadow">
                    <div class="card-body">
                        <h5><i class="fa fa-user"></i> Добавить Администратора</h5>
                        <hr>
                        <form @submit.prevent="submit">
                            ...
                            <button type="submit" class="btn btn-md btn-primary border-0 shadow me-2">Сохранить</button>
                        </form>
                    </div>
                </div>
            </div>
        ...
        const submit = () => {
            ...
            Inertia.post('/admin/users', {
                ...
                onSuccess: () => {
                    ...
                    Swal.fire({
                        title: 'Успех!',
                        text: 'Сотрудник успешно сохранен.',
                        icon: 'success',
